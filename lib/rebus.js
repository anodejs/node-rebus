...
var facadeFactory = require('ypatterns').syncasyncFacadeFactory;
...
// Rebus factory.
// Create an instance of rebus in specified folder. The instance can be used in completion callback.
...
module.exports = function (folder, options, callback) {
    ...
    */
    ...
    return facadeFactory({ create: createInstance, initializeAsync: initializeAsync, initializeSync: initializeSync }, callback);
