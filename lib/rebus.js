        ...
        start: function (folder, callback) {
            ...
            fs.mkdir(folder, 0777, function (err) {
                ...
                fs.readdir(folder, function (err, files) {
                    ...
                    // When files are loaded, start watchdog on changes and return rebus instance to the caller
                    // via callback.
            ...
            function _loadFile(filename, callback) {
                ...
                fs.readFile(filepath, function (err, data) {
                    ...
                    try {
                        ...
                        console.warn('Object ' + filename + ' was not yet fully written, exception:', e);
