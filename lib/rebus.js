...
var facadeFactory = require('ypatterns').facadeFactory;
...
//  rebusInstnace includes 2 methods:
//      - publish
//      - subscribe
// Returns: handle for rebus instance with method close on it.
module.exports = function (folder, options, callback) {
    ...
    // Create rebus instance
    var rebusInstance = function () {

        // Folder watching handler.
        var watcher;

        // Return unitialized instance that is used by facade to create
        // the real instance.
        ...
        function initialize(callback) {
            ...
            */
            ...
            function _startWatchdog(callback) {
                ...
                // Create new instance and provide access to its public functions.
    ...
    // Create facade for rebus factory. 
    // Returns handle that can be closed to trigger cleanup.
    return facadeFactory(rebusInstance, callback);
}
